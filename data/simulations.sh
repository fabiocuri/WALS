...
python3 translate.py -model data/En-Fr/tanh_adam_0002_enctgt_step_100.pt -src data/En-Fr/test_src.en -output data/En-Fr/pred_A1.fr -replace_unk -wals_src eng -wals_tgt fre -wals_model EncInitHidden_Target -wals_function tanh

#python3 translate.py -model data/En-Fr/tanh_adam_00022_encboth_step_100.pt -src data/En-Fr/test_src.en -output data/En-Fr/pred_A2.fr -replace_unk -wals_src eng -wals_tgt fre -wals_model EncInitHidden_Both -wals_function tanh

#python3 translate.py -model data/En-Fr/tanh_adam_0002_dectgt_step_100.pt -src data/En-Fr/test_src.en -output data/En-Fr/pred_B1.fr -replace_unk -wals_src eng -wals_tgt fre -wals_model DecInitHidden_Target -wals_function tanh

#python3 translate.py -model data/En-Fr/tanh_adam_0002_decboth_step_100.pt -src data/En-Fr/test_src.en -output data/En-Fr/pred_B2.fr -replace_unk -wals_src eng -wals_tgt fre -wals_model DecInitHidden_Both -wals_function tanh

#python3 translate.py -model data/En-Fr/tanh_adam_0002_10_wals2srctgt_step_100.pt -src data/En-Fr/test_src.en -output data/En-Fr/pred_C1.fr -replace_unk -wals_src eng -wals_tgt fre -wals_model WalstoSource_Target -wals_function tanh -wals_size 10

#python3 translate.py -model data/En-Fr/tanh_adam_0002_10_wals2srcboth_step_100.pt -src data/En-Fr/test_src.en -output data/En-Fr/pred_C2.fr -replace_unk -wals_src eng -wals_tgt fre -wals_model WalstoSource_Both -wals_function tanh -wals_size 10

#python3 translate.py -model data/En-Fr/tanh_adam_0002_10_wals2tgttgt_step_100.pt -src data/En-Fr/test_src.en -output data/En-Fr/pred_D1.fr -replace_unk -wals_src eng -wals_tgt fre -wals_model WalstoTarget_Target -wals_function tanh -wals_size 10

#python3 translate.py -model data/En-Fr/tanh_adam_0002_10_wals2tgtboth_step_100.pt -src data/En-Fr/test_src.en -output data/En-Fr/pred_D2.fr -replace_unk -wals_src eng -wals_tgt fre -wals_model WalstoTarget_Both -wals_function tanh -wals_size 10
